def lang_phrases(lang, num):
    if lang == 0:
        phrases = ['Оқушының жеке 🆔 енгізіңіз. Егер сіз оқушының 🆔 білмесеңіз, тәлімгеріңізден( куратордан) сұрап біле аласыз.',  # 0
                   'Біздің жүйеде түркелген нөміріңізді мына форматта енгізіңіз 87********* 📱',  # 1
                   ...
                   '{0}\n'
                   'Сізге өткізілген сабақтар туралы хабарлаймыз.\n'
                   'Күні: {1}\n'
                   'Тақырып: {2}\n'
                   'Сабақтың тақырыбы: {3}\n'
                   'Үй тапсырмасы\n'
